...
g.add("-A", "--assembly", help="The genome assembly (GRCh37 or GRCh38)")
...
assembly = args.assembly or 'GRCh37'
...
job.add("python -u IN:parse_clinvar_xml.py -x IN:%s -o OUT:clinvar_table_raw.tsv -a %s" %(clinvar_xml, assembly) )
